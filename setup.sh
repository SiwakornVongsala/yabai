...
ln -sfn "$REPO_DIR/yabai/dev-mobile-layout.sh" "$HOME/.config/yabai/dev-mobile-layout.sh"
ln -sfn "$REPO_DIR/skhd/skhdrc" "$HOME/.config/skhd/skhdrc"
chmod +x "$REPO_DIR/yabai/yabairc" "$REPO_DIR/yabai/float-large-space.sh" "$REPO_DIR/yabai/swap-largest-window.sh" "$REPO_DIR/yabai/dev-mobile-layout.sh"
